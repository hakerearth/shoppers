...
if(isset($_SESSION['cart'])) {
  ...
  $total = 0;
  $temp_address= "$ADDRESS " . " $CITY " . " $ZIP " ;

  $_SESSION['temp_address']=$temp_address;
  ...
  foreach($_SESSION['cart'] as $product_id => $quantity) {
    ...
    if($result){
      ...
      if($obj = $result->fetch_object()) {
        ...
        $query = $mysqli->query("INSERT INTO orders (product_code, product_name, product_desc, price, units, total, email,address) VALUES('$obj->product_code', '$obj->product_name', '$obj->product_desc', $obj->price, $quantity, $cost, '$user','$temp_address')");
